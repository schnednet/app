 ...
 * @generated
 */
public class EpcBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	{		
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(EpcVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						EpcBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateArc_4001(Epc container, Element source,
				Element target) {
			return canExistArc_4001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRelation_4002(Epc container,
				Element source, Element target) {
			return canExistRelation_4002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateInformationArc_4003(Epc container,
				Element source, Element target) {
			return canExistInformationArc_4003(container, source, target);
		}
