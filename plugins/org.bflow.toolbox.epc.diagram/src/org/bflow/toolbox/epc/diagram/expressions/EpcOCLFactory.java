...
public class EpcOCLFactory {
	...
	protected EpcOCLFactory() {
		...
		this.expressionBodies = new String[] {
				...
				"((self.oclIsTypeOf(Function) and (oppositeEnd.oclIsKindOf(Event) or oppositeEnd.oclIsKindOf(Function) or oppositeEnd.oclIsKindOf(OR) or oppositeEnd.oclIsKindOf(XOR) or oppositeEnd.oclIsKindOf(AND))) or (oppositeEnd.oclIsTypeOf(Function) and (self.oclIsKindOf(Event) or self.oclIsKindOf(Function) or self.oclIsKindOf(OR) or self.oclIsKindOf(XOR) or self.oclIsKindOf(AND))) or (self.oclIsTypeOf(Event) and (oppositeEnd.oclIsKindOf(Function) or oppositeEnd.oclIsKindOf(OR) or oppositeEnd.oclIsKindOf(XOR) or oppositeEnd.oclIsKindOf(AND))) or (oppositeEnd.oclIsTypeOf(Event) and (self.oclIsKindOf(Function) or self.oclIsKindOf(OR) or self.oclIsKindOf(XOR) or self.oclIsKindOf(AND))) or (self.oclIsTypeOf(OR) and (oppositeEnd.oclIsKindOf(Event) or oppositeEnd.oclIsKindOf(Function) or oppositeEnd.oclIsKindOf(OR) or oppositeEnd.oclIsKindOf(XOR) or oppositeEnd.oclIsKindOf(AND))) or (oppositeEnd.oclIsTypeOf(OR) and (self.oclIsKindOf(Event) or self.oclIsKindOf(Function) or self.oclIsKindOf(OR) or self.oclIsKindOf(XOR) or self.oclIsKindOf(AND))) or (self.oclIsTypeOf(XOR) and (oppositeEnd.oclIsKindOf(Event) or oppositeEnd.oclIsKindOf(Function) or oppositeEnd.oclIsKindOf(OR) or oppositeEnd.oclIsKindOf(XOR) or oppositeEnd.oclIsKindOf(AND))) or (oppositeEnd.oclIsTypeOf(XOR) and (self.oclIsKindOf(Event) or self.oclIsKindOf(Function) or self.oclIsKindOf(OR) or self.oclIsKindOf(XOR) or self.oclIsKindOf(AND))) or (self.oclIsTypeOf(AND) and (oppositeEnd.oclIsKindOf(Event) or oppositeEnd.oclIsKindOf(Function) or oppositeEnd.oclIsKindOf(OR) or oppositeEnd.oclIsKindOf(XOR) or oppositeEnd.oclIsKindOf(AND))) or (oppositeEnd.oclIsTypeOf(AND) and (self.oclIsKindOf(Event) or self.oclIsKindOf(Function) or self.oclIsKindOf(OR) or self.oclIsKindOf(XOR) or self.oclIsKindOf(AND))))", //$NON-NLS-1$
				"self <> oppositeEnd", //$NON-NLS-1$
				"((self.oclIsTypeOf(Function) and (oppositeEnd.oclIsKindOf(Product) or oppositeEnd.oclIsKindOf(Objective) or oppositeEnd.oclIsKindOf(Application) or oppositeEnd.oclIsKindOf(ProcessInterface) or oppositeEnd.oclIsKindOf(TechnicalTerm) or oppositeEnd.oclIsKindOf(File) or oppositeEnd.oclIsKindOf(Document) or oppositeEnd.oclIsKindOf(Cluster) or oppositeEnd.oclIsKindOf(CardFile))) or (oppositeEnd.oclIsTypeOf(Function) and (self.oclIsKindOf(Product) or self.oclIsKindOf(Objective) or self.oclIsKindOf(Application) or self.oclIsKindOf(ProcessInterface) or self.oclIsKindOf(TechnicalTerm) or self.oclIsKindOf(File) or self.oclIsKindOf(Document) or self.oclIsKindOf(Cluster) or self.oclIsKindOf(CardFile))))", //$NON-NLS-1$
				"self <> oppositeEnd", //$NON-NLS-1$
				"((self.oclIsTypeOf(Function) and (oppositeEnd.oclIsKindOf(PersonType) or oppositeEnd.oclIsKindOf(Participant) or oppositeEnd.oclIsKindOf(Group) or oppositeEnd.oclIsKindOf(Location) or oppositeEnd.oclIsKindOf(Position) or oppositeEnd.oclIsKindOf(InternalPerson) or oppositeEnd.oclIsKindOf(ExternalPerson))) or (oppositeEnd.oclIsTypeOf(Function) and (self.oclIsKindOf(PersonType) or self.oclIsKindOf(Participant) or self.oclIsKindOf(Group) or self.oclIsKindOf(Location) or self.oclIsKindOf(Position) or self.oclIsKindOf(InternalPerson) or self.oclIsKindOf(ExternalPerson))))", //$NON-NLS-1$
		};
	}
