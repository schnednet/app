...
import vcchart.diagram.edit.commands.VcCreateShortcutDecorationsCommand;
import vcchart.diagram.edit.policies.ModelCanonicalEditPolicy;
import vcchart.diagram.edit.policies.ModelItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						VcVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new VcCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
