...
public class TechnicalTermEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new TechnicalTermFigure();
	}
		...
		if (childEditPart instanceof TechnicalTermNameEditPart) {
			((TechnicalTermNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTechnicalTermLabelFigure());
			return true;
		}
		return false;
	}
	...
	public class TechnicalTermFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTechnicalTermLabelFigure;
		...
		private void createContents() {
			...
			fFigureTechnicalTermLabelFigure.setText("TechnicalTerm");
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTechnicalTermLabelFigure() {
			return fFigureTechnicalTermLabelFigure;
		}
